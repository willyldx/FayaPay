...
import com.fayapay.gateway.di.appModule
 ...
 */
class FayaGatewayApp : Application() {

    companion object {
        const val NOTIFICATION_CHANNEL_ID = "fayapay_gateway_service"
    ...
    override fun onCreate() {
        ...
        Timber.i("FayaGatewayApp — initializing")
        ...
        startKoin {
            ...
            androidContext(this@FayaGatewayApp)
            modules(appModule)
        }

        Timber.i("FayaGatewayApp — ready")
    }
