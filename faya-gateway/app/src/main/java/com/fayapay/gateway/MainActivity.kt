...
import com.fayapay.gateway.core.GatewayManager
import com.fayapay.gateway.core.GatewayService
import com.fayapay.gateway.core.LogManager
import com.fayapay.gateway.databinding.ActivityMainBinding
import com.fayapay.gateway.sim.SimManager
import com.fayapay.gateway.ui.LogAdapter
import com.fayapay.gateway.ussd.UssdAccessibilityService
...
/**
 * Minimal technical UI for the FayaPay Gateway device.
 *
 * Responsibilities:
...
class MainActivity : AppCompatActivity() {
        ...
        lifecycleScope.launch {
            try {
                val deviceInfo = org.koin.java.KoinJavaComponent.getKoin()
                    .get<com.fayapay.gateway.core.DeviceInfo>()
    ...
    private fun showPermissionRationaleDialog(permissions: List<String>) {
        ...
        val message = buildString {
            append("FayaPay Gateway a besoin des permissions suivantes :\n\n")
            if (hasSms) {
    ...
    private fun openAccessibilitySettings() {
        try {
            ...
            Toast.makeText(
                this,
                "Activez « FayaPay Gateway » dans la liste des services",
                Toast.LENGTH_LONG
            ).show()
        } catch (e: Exception) {
