...
> Ce projet fait partie du monorepo `fayapay/faya-dashboard/`

---

## 1. Contexte du projet

`faya-dashboard` est l'interface web B2B de FayaPay. C'est ce que voient
les merchants après inscription — leur espace de gestion complet.

Il consomme exclusivement l'API REST de `faya-backend`.
...
qui ont intégré FayaPay dans leur plateforme.
...
```
- Liste des clés actives avec préfixe visible (faya_live_xxxx...)
- Date de création
...
```
Palette de couleurs :
- Primaire    : #F97316 (orange — couleur FayaPay)
- Succès      : #22C55E (vert)
- Erreur      : #EF4444 (rouge)
