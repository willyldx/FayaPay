  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className="flex items-center gap-1.5 rounded-lg border border-kadryza-200 px-3 py-2
                   text-sm font-medium text-kadryza-600
                   transition-colors hover:bg-kadryza-50
          ...
          <div className="p-4">
            ...
            {testMutation.isPending && !result && (
              <div className="flex items-center gap-3 text-sm text-slate-500">
                <Loader2 className="h-5 w-5 animate-spin text-kadryza-500" />
                <div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between pt-1">
                  <button
                    ...
                    className="flex items-center gap-1.5 text-xs font-medium text-kadryza-500 hover:text-kadryza-600 transition-colors"
                  >
