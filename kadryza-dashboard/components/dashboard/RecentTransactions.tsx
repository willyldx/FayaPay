  ...
  return (
    <div className="card">
      ...
      <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100">
        ...
        <Link
          href="/transactions"
          className="flex items-center gap-1.5 text-sm font-medium text-kadryza-500 hover:text-kadryza-600 transition-colors"
        >
          Tout voir
                ...
                >
                  <td className="whitespace-nowrap px-6 py-3.5">
                    <Link
                      ...
                      className="text-sm font-medium text-slate-900 font-mono hover:text-kadryza-500 transition-colors"
                    >
                      {tx.reference}
                    </Link>
