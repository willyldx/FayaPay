    ...
    <>
      <header className="sticky top-0 z-20 flex h-16 items-center justify-between border-b border-slate-200 bg-white/95 backdrop-blur-sm px-4 sm:px-6 lg:hidden">
        ...
        <div className="flex items-center gap-2">
          <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-kadryza-500">
            <svg
              viewBox="0 0 24 24"
              fill="none"
        ...
        {/* Avatar merchant */}
        <div className="flex h-9 w-9 items-center justify-center rounded-full bg-kadryza-100 text-kadryza-600">
