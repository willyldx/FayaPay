...
export class KadryzaApiError extends Error {
  public readonly status: number
  public readonly code: string

  constructor(message: string, status: number, code: string) {
    super(message)
    this.name = 'KadryzaApiError'
    this.status = status
    this.code = code
  }
}
