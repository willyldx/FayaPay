...
/**
 * Base error class for all Kadryza SDK errors.
...
export class KadryzaValidationError extends KadryzaError {
  ...
  constructor(message: string, fields?: Record<string, string>) {
    ...
    this.name = 'KadryzaValidationError'
    this.fields = fields
  }
...
export class KadryzaNotFoundError extends KadryzaError {
  constructor(message = 'Resource not found') {
    ...
    this.name = 'KadryzaNotFoundError'
  }
}
...
export class KadryzaDuplicateError extends KadryzaError {
  ...
  constructor(message: string, existingTransaction?: Transaction) {
    ...
    this.name = 'KadryzaDuplicateError'
...
/**
 * Thrown when the Kadryza Android gateway is disconnected.
 * HTTP 503.
 */
export class KadryzaGatewayUnavailableError extends KadryzaError {
  constructor(message = 'Payment gateway is currently unavailable') {
    ...
    this.name = 'KadryzaGatewayUnavailableError'
  }
}
