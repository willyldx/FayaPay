package com.kadryza.gateway.websocket

import com.kadryza.gateway.core.DeviceInfo
import com.kadryza.gateway.protocol.IncomingMessage
import com.kadryza.gateway.protocol.OutgoingMessage
...
/**
 * OkHttp WebSocket client managing the persistent connection to kadryza-backend.
 *
 * Architecture:
