...
import com.kadryza.gateway.KadryzaGatewayApp
import com.kadryza.gateway.MainActivity
import com.kadryza.gateway.R
...
/**
 * The heart of kadryza-gateway. This foreground service runs indefinitely
 * on the dedicated Android device, maintaining the WebSocket connection
 * to kadryza-backend and orchestrating USSD/SMS operations.
 *
 * Lifecycle:
...
class GatewayService : Service() {
    ...
    companion object {
        const val ACTION_START = "com.kadryza.gateway.ACTION_START"
        const val ACTION_STOP = "com.kadryza.gateway.ACTION_STOP"
        const val ACTION_UPDATE_NOTIFICATION = "com.kadryza.gateway.ACTION_UPDATE_NOTIFICATION"

        const val EXTRA_NOTIFICATION_TEXT = "notification_text"

        private const val WAKE_LOCK_TAG = "KadryzaGateway::ServiceWakeLock"
    }
    ...
    private fun startForegroundWithNotification() {
        ...
        startForeground(
            KadryzaGatewayApp.NOTIFICATION_ID,
            notification,
    ...
    private fun buildNotification(contentText: String): Notification {
        ...
        return NotificationCompat.Builder(this, KadryzaGatewayApp.NOTIFICATION_CHANNEL_ID)
    ...
    fun updateNotification(text: String) {
        ...
        manager.notify(KadryzaGatewayApp.NOTIFICATION_ID, notification)
    }
