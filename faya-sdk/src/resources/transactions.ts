 ...
 *
 * Not instantiated directly by merchants. Access via `faya.transactions`.
 */
export class Transactions {
   ...
   *
   * @throws {FayaPayValidationError} If parameters are invalid
   * @throws {FayaPayDuplicateError} If the reference was already used
   ...
   * @throws {FayaPayNotFoundError} If the transaction does not exist
   */
