 ...
 *
 * Shows how to securely verify incoming FayaPay webhook requests
...
const app = express()
const WEBHOOK_SECRET = process.env.FAYAPAY_WEBHOOK_SECRET!
...
app.post(
  ...
  (req, res) => {
    ...
    const signature = req.headers['x-faya-signature'] as string | undefined
