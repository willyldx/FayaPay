...
**Faya Pay** est une infrastructure de paiement Mobile Money pour le Tchad et la zone CEMAC.
En l'absence d'API publiques des opérateurs locaux (Airtel Money, Moov Money), Faya Pay utilise
...
`faya-backend` est le cerveau central du système. Il :
...
CREATE TABLE merchants (
    ...
    api_key_prefix VARCHAR(10),                  -- Ex: "faya_live_" pour affichage
...
CREATE TABLE transactions (
    ...
    internal_ref    VARCHAR(100) UNIQUE NOT NULL,  -- Référence interne Faya
...
```json
{
  ...
  "internal_ref": "FAYA-20240115-XXXX",
  "status": "PENDING",
...
**Header de signature :**
```
X-Faya-Signature: sha256=<hmac_hex>
```
...
# PostgreSQL
DATABASE_URL=postgres://faya:password@localhost:5432/fayapay?sslmode=disable
